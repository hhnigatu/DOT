...
import torch
import tqdm
from transformers import AdamW, LayoutLMv2FeatureExtractor, LayoutLMv2TokenizerFast, LayoutLMv2Processor,  LayoutLMv2ForSequenceClassification
...
def train(model, device, optimizer, epochs,train_data, labels, traindataloader, valdataloader):
...
def preprocess_data(batch, processor, column='rep_image', labeled=False, labels = ['image', 'other', 'narrative', 'form', 'handwriting', 'interview']):
